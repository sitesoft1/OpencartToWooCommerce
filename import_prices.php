...
if(!empty($_POST)){
	...
	foreach($_POST as $product_id => $value){
	 ...
	 $rez = $db->updateDbPrice($product_id, $name, $price, $woocommerce);
	 echo $rez;
		
		//$db->log('price_import_log', $value, true);
		//$db->log('price_import_id_log', $product_id, true);
